...
FULL_LORE_PATH = BASE_DIR / 'data' / 'users_export' / 'FULL_LORE.txt'
ANALYTICS_PATH = BASE_DIR / 'data' / 'chat_analytics.json'

lore_profiles = {}

if FULL_LORE_PATH.exists():
...
if ANALYTICS_PATH.exists():
    ...
    # Ensure complete fallback values
    ...
    print("All profiles in chat_analytics.json verified!")
